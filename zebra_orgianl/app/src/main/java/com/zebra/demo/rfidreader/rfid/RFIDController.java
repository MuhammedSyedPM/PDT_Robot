...
import com.zebra.demo.rfidreader.reader_connection.ReaderBTDevice;
...
public class RFIDController {
    ...
    public static BEEPER_VOLUME hostBeeperVolume = BEEPER_VOLUME.HIGH_BEEP;
    // Singulation control
    public static Antennas.SingulationControl singulationControl;
    // Endpoint Config
    public static EndpointConfigurationInfo endpointConfiguration;
    // regulatory
    ...
    private short[] selectedAntennas = null;
    public static int editEndpointPos = -1;
    public static int addEndpointPos = -1;

    public static boolean fingerRestMode = false;
    public static int timerForLock = 4;
    public static boolean isTriggerLocked = false;
    ...
    public void inventoryWithMemoryBank(String memoryBankID, RfidListeners rfidListeners) {
        AntennaInfo antennaInfo = new AntennaInfo(selectedAntennas);;
    ...
    public void accessOperationsRead(String tagValue, String offsetText, String lengthText, String accessRwPassword, String bankItem, RfidListeners rfidListeners) {
        AntennaInfo antennaInfo = new AntennaInfo(selectedAntennas);
        accessOperationController.accessOperationsRead(tagValue, offsetText, lengthText, accessRwPassword, bankItem, rfidListeners, antennaInfo);
    }
    ...
    public void accessOperationsWrite(String tagValue, String offsetText, String lengthText, String accessRWData, String accessRwPassword, String bankItem, RfidListeners rfidListeners) {
        AntennaInfo antennaInfo = new AntennaInfo(selectedAntennas);
        accessOperationController.accessOperationsWrite(tagValue, offsetText, lengthText, accessRWData, accessRwPassword, bankItem, rfidListeners, antennaInfo);
    }
    ...
    public void accessOperationLock(String tagId, String accessRwPassword, LOCK_DATA_FIELD lockDataField, LOCK_PRIVILEGE lockPrivilege, boolean ALL_Memory_Bank, RfidListeners rfidListeners) {
        AntennaInfo antennaInfo = new AntennaInfo(selectedAntennas);
        accessOperationController.accessOperationLock(tagId, accessRwPassword, lockDataField, lockPrivilege,ALL_Memory_Bank, rfidListeners, antennaInfo );
    }

    public void accessOperationsKill(String tagId, String accessRWpassword, RfidListeners rfidListeners) {
        AntennaInfo antennaInfo = new AntennaInfo(selectedAntennas);
        accessOperationController.accessOperationsKill(tagId, accessRWpassword, rfidListeners, antennaInfo);
    }
    ...
    public void setSelectedAntennas(short[] antennas) {
        this.selectedAntennas = antennas;
    }

    public short[] getSelectedAntennas() {
