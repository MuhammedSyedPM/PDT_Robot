...
public class ActiveDeviceAdapter extends FragmentStatePagerAdapter {
    ...
    public static final int WIFI_STATUS_TAB = 47;
    ...
    public static final int WIFI_MAIN_PAGE = 52;
    public static final int READER_WIFI_CERTIFICATE_TAB = 53;
	public static final int ENDPOINT_CONFIGURATION_PAGE = 54;
    public static final int ENDPOINT_CONFIG_SETTINGS_PAGE = 55;
    public  static  final int ENDPOINT_STATUS_PAGE = 56;
    public  static  final int ENDPOINT_MAIN_PAGE = 57;
    public static final int ADMIN_LOGIN_PAGE = 58;
    public static final int ADMIN_CHANGE_PASSWORD_PAGE = 59;
            ...
            case SETTINGS_TAB:
                switch(mNextSettingsFragmentId)
                {
                    ...
                    case BATTERY_STATISTICS_TAB:
                        ...
                        else if(RFIDController.mConnectedReader.getHostName().contains("FXP20"))
                        {
                        mMainSettingsFragment =  BatteryFragementFXP20.newInstance();
                        }
                        else
                    ...
                    case USB_MIFI_TAB:
                        ...
                        return mMainSettingsFragment;
                    case WIFI_MAIN_PAGE:
                        mMainSettingsFragment = WiFiMainPage.newInstance();
                        return mMainSettingsFragment;
                    case READER_WIFI_SETTINGS_TAB:
                        mMainSettingsFragment = ReaderWifiSettingsFragment.newInstance();
                        return mMainSettingsFragment;
                    case READER_WIFI_CERTIFICATE_TAB:
                        mMainSettingsFragment = ReaderCertificatesFragment.newInstance();
                        return mMainSettingsFragment;
					case ENDPOINT_CONFIGURATION_PAGE:
                        mMainSettingsFragment = EndpointConfigFragment.newInstance();
                        return mMainSettingsFragment;
                    case ENDPOINT_CONFIG_SETTINGS_PAGE:
                        mMainSettingsFragment = EndpointConfigSettingsFragment.newInstance();
                        return mMainSettingsFragment;
                    case ENDPOINT_STATUS_PAGE:
                        mMainSettingsFragment = EndpointStatusFragment.newInstance();
                        return mMainSettingsFragment;
                    case ENDPOINT_MAIN_PAGE:
                        mMainSettingsFragment = EndpointMainPage.newInstance();
                        return  mMainSettingsFragment;
                    case ADMIN_LOGIN_PAGE:
                        mMainSettingsFragment = AdminLoginFragment.newInstance();
                        return mMainSettingsFragment;
                    case ADMIN_CHANGE_PASSWORD_PAGE:
                        mMainSettingsFragment = AdminChangePasswordFragment.newInstance();
                        return  mMainSettingsFragment;
                    default:
                    ...
                    switch(mNextSettingsFragmentId)
                    {
                        ...
                        case RFID_PROFILES_TAB:
                            ...
                            if ("RE40".equalsIgnoreCase(model)) {
                                mMainSettingsFragment = ProfileFragmentRE40.newInstance();
                            } else if(modelName.contains("FXP20")){
                                mMainSettingsFragment = ProfilesFragmentFXP20.newInstance();
                            }
                            else {
                                mMainSettingsFragment = ProfileFragment.newInstance();
                            }
                        ...
                        case RFID_SETTINGS_TAB:
                            ...
                            return mMainSettingsFragment;
                        case BATTERY_STATISTICS_TAB:
                            if(mModelName.startsWith("RFD40") || mModelName.startsWith("RFD90") || mModelName.startsWith("RFID")|| isCharmanderDevice())
                                mMainSettingsFragment = BatteryStatsFragment.newInstance();
