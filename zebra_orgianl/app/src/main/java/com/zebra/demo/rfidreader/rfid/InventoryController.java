...
public class InventoryController {
    ...
    public void inventoryWithTamperfind(String memoryBankID, RfidListeners rfidListeners, AntennaInfo antennaInfo) {
        ...
        if (RFIDController.mConnectedReader != null && RFIDController.mConnectedReader.isConnected()) {
            ...
            try {
                ...
                RFIDController.mConnectedReader.Actions.TagAccess.readEvent(readAccessParams, null, antennaInfo);
    ...
    public void inventoryWithMemoryBank(String memoryBankID, RfidListeners rfidListeners, AntennaInfo antennaInfo) {

        if (RFIDController.mConnectedReader != null && RFIDController.mConnectedReader.isConnected()) {
            TagAccess tagAccess = new TagAccess();
            TagAccess.ReadAccessParams readAccessParams = tagAccess.new ReadAccessParams();
            //Set the param values
            readAccessParams.setCount(Application.wordCount);
    ...
    public void performInventory(final RfidListeners rfidListeners, AntennaInfo antennaInfo) {
                ...
                try {
                    if (RFIDController.brandidcheckenabled) {
                        ...
                        if (Application.strBrandID != null && Application.strBrandID.length() > 0) {
                            ...
                            RFIDController.mConnectedReader.Actions.Inventory.perform(null, null, antennaInfo);
                    } else
                        RFIDController.mConnectedReader.Actions.Inventory.perform(null, null, antennaInfo);
                    RFIDController.mIsInventoryRunning = true;
                    rfidListeners.onSuccess(null);
