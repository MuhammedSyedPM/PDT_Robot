...
public class AccessOperationController {
    ...
    public void accessOperationsRead(final String tagValue, String offsetText, String lengthText, String accessRwPassword, String bankItem, final RfidListeners rfidListeners, AntennaInfo antennaInfo) {
        ...
        new AsyncTask<Void, Void, TagData>() {
            ...
            protected TagData doInBackground(Void... voids) {
                try {
                    ...
                    final TagData tagData = RFIDController.mConnectedReader.Actions.TagAccess.readWait(tagValue, readAccessParams, antennaInfo, bFilter);
                    return tagData;
    ...
    public void accessOperationsWrite(final String tagValue, String offsetText, String lengthText, String accessRWData, String accessRwPassword,
                                      String bankItem, final RfidListeners rfidListeners, AntennaInfo antennaInfo) {
        RFIDController.isAccessCriteriaRead = true;
        TagAccess tagAccess = new TagAccess();
        ...
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... voids) {
                try {
                    ...
                    //if we are dealing with more than 255 bits access operation then set bFilter false
                    Boolean bFilter = (tagValue.length() <= 24 );
                    RFIDController.mConnectedReader.Actions.TagAccess.writeWait(tagValue, writeAccessParams, antennaInfo, null, bFilter, false);
                    bResult = true;
                } catch (InvalidUsageException e) {
                    invalidUsageException = e;
                    if( e!= null && e.getStackTrace().length>0){ Log.e(TAG, e.getStackTrace()[0].toString()); }
    ...
    public void accessOperationLock(final String tagId, String accessRwPassword, LOCK_DATA_FIELD lockDataField, LOCK_PRIVILEGE lockPrivilege, boolean ALL_Memory_Bank, final RfidListeners rfidListeners, AntennaInfo antennaInfo) {
        ...
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... voids) {
                try {
                    setAccessProfile(true);
                    Boolean bFilter = (tagId.length() <= 24 );
                    RFIDController.mConnectedReader.Actions.TagAccess.lockWait(tagId, lockAccessParams, antennaInfo, bFilter);
                    bResult = true;
                } catch (InvalidUsageException e) {
                    invalidUsageException = e;
                    if( e!= null && e.getStackTrace().length>0){ Log.e(TAG, e.getStackTrace()[0].toString()); }
    ...
    public void accessOperationsKill(final String tagId, String accessRWpassword, final RfidListeners rfidListeners, AntennaInfo antennaInfo) {
        RFIDController.accessControlTag = tagId;
        RFIDController.isAccessCriteriaRead = true;
        //Set the param values
        TagAccess tagAccess = new TagAccess();
        ...
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... voids) {
                try {
                    setAccessProfile(true);
                    Boolean bFilter = (tagId.length() <= 24 );
                    RFIDController.mConnectedReader.Actions.TagAccess.killWait(tagId, killAccessParams, antennaInfo, bFilter);
                    bResult = true;
                } catch (InvalidUsageException e) {
                    invalidUsageException = e;
                    if( e!= null && e.getStackTrace().length>0){ Log.e(TAG, e.getStackTrace()[0].toString()); }
