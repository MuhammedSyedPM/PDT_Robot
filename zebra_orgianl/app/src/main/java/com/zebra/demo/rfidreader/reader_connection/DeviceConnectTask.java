    ...
    protected Boolean doInBackground(Void... a) {
        ...
        if (connectingDevice.getRFIDReader().isConnected()) {
            ...
            if(RFIDController.mConnectedReader.getHostName().startsWith("RFID") ||
                    RFIDController.mConnectedReader.getHostName().contains("FXP20")){
                connectingDevice.setSerialNumber(RFIDController.mConnectedReader.ReaderCapabilities.getSerialNumber());  //Updating RE40 model serial number
            }
