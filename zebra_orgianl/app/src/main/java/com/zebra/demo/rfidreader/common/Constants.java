...
public class Constants {
    ...
    public static final int RESPONSE_TIMEOUT = 9000;
    ...
    public static final String FINGER_REST_MODE = "FINGER_REST_MODE";
    public static final int TIMER_FOR_LOCK = 4;
    ...
    public static final String TAG_POPULATION = "TAG_POPULATION";
    public static final String SL_FLAG = "SL_FLAG";
