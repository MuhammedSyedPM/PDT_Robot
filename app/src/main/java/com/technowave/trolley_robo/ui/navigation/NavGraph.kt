package com.technowave.trolley_robo.ui.navigation

import androidx.compose.runtime.Composable
import androidx.navigation.compose.NavHost
import androidx.navigation.compose.composable
import androidx.navigation.compose.rememberNavController
import com.technowave.trolley_robo.ui.home.HomeScreen
import com.technowave.trolley_robo.ui.login.LoginScreen

import com.technowave.trolley_robo.ui.splash.SplashScreen
...
fun NavGraph(
    ...
    NavHost(
        ...
        composable("scan") {
            com.technowave.trolley_robo.ui.scan.ScanScreen(
                onBack = { navController.popBackStack() },
                onRackStatusClick = { navController.navigate("rack_status") }
            )
        }
        composable("download_rack") {
            com.technowave.trolley_robo.ui.download.DownloadRackScreen(
                onBack = { navController.popBackStack() }
            )
        }
        composable("rack_status") {
            com.technowave.trolley_robo.ui.report.RackStatusScreen(
                onBack = { navController.popBackStack() }
            )
        }
        composable("stock_status") {
            com.technowave.trolley_robo.ui.report.StockStatusScreen(
                onBack = { navController.popBackStack() }
            )
        }
        composable("to_be_uploaded") {
            com.technowave.trolley_robo.ui.report.ToBeUploadedScreen(
                onBack = { navController.popBackStack() }
            )
        }
    }
